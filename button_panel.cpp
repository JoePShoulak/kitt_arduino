...
ButtonPanel::ButtonPanel(lv_obj_t *parent, ButtonData const *config) {
    ...
    static lv_coord_t row_dsc[] = {button_size, button_size, button_size,
                                   button_size, button_size, LV_GRID_TEMPLATE_LAST};
...
ButtonPanel *ButtonPanel::createTile(lv_obj_t *tileview, int row_id, ButtonData const *config) {
